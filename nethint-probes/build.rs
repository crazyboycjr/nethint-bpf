...
fn create_module(path: PathBuf, name: &str, bindings: &str) -> io::Result<()> {
    ...
    let res = writeln!(
        &mut file,
        r"
/// Auto generated by BPF bindgen for nethint-probes
mod {name} {{
...
fn main() {
    // Compilation of nethint-probes is executed twice.
    // - Once for building probes by a build-script of nethint-userspace
